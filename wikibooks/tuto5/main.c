...
void space_compute()
  ...
  transform = mul4(transform, rot4(0.25*glfwGetTime() * PI, 1, 2));
  transform = mul4(transform, rot4(0.3 * PI * glfwGetTime(), 0, 2));
  transform = mul4(transform, rot4(0.5*glfwGetTime() * PI, 0, 1));
