...
int init_resources()
  ...
  struct attributes triangle_attributes[3] =
    {
      { .coord3d = { 0.0, 0.6,-0.6 }, .color = {1.0, 0.5, 0.0, } },
      { .coord3d = {-0.6,-0.6,-0.6 }, .color = {1.0, 1.0, 0.0, } },
      { .coord3d = { 0.6,-0.6,-0.6 }, .color = {1.0, 0.0, 0.0, } },
    };
  GLint compile_ok;
